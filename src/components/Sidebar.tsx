            ...
            {presets.map((preset) => (
              ...
              >
                ...
                <span className="text-[10px] text-zinc-500">
                  ...
                  {preset.settings.quality} • {preset.settings.longestSide}px{preset.settings.hasBorder ? " • Border" : ""}{preset.settings.lrWarmth !== 0 ? ` • Warmth: ${preset.settings.lrWarmth > 0 ? "+" : ""}${preset.settings.lrWarmth}` : ""}
                </span>
              </button>
            ))}
          </div>
